...
export default function LayoutComponent({ children, navItems, portalType }) {
  ...
  // Check if mentor profile lacks required initial setup fields
  const isProfileIncomplete =
    portalType === "mentor" && (!user?.experience || !user?.availability);
  ...
  const handleCloseProfileModal = () => {
    // Block closing if profile remains incomplete
    if (!isProfileIncomplete) {
      setActiveModal(null);
    }
  };
    ...
    <div className="flex h-screen w-full bg-[#0F172A] text-slate-200 overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative h-full">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col text-left">
                <span className="text-lg lg:text-2xl font-bold text-white tracking-tight leading-none">
                  Acadara
                </span>
        ...
        <ProfileModal
          ...
          preventClose={isProfileIncomplete}
          noticeMessage={
            isProfileIncomplete
              ? "Please complete your experience and availability details before proceeding."
              : null
          }
        />
        <SettingsModal
