...
export default function MentorChats() {
  const { getReceivedRequests } = useUserService(); // For the sidebar list
          ...
          {contacts.map((contact) => (
            ...
            >
              ...
              <div className="text-left overflow-hidden">
                ...
                <p className="text-[10px] text-slate-500 uppercase font-black truncate">{contact.Mentee?.mentee_subject}</p>
              </div>
            </button>
          ))}
        </div>
          ...
          <>
            ...
            <div className="p-4 px-8 border-b border-slate-800 flex justify-between items-center bg-slate-900/30">
              <div className="flex items-center gap-3">
                ...
                <span className="font-black text-white italic uppercase text-sm tracking-widest">{activeContact.Mentee?.user?.usr_name}</span>
              </div>
